...
import logo from "../images/IRCTC_logo.png";
      ...
      <nav className="navbar navbar-expand-lg custom-bg text-color">
        <div className="container-fluid text-color">
          ...
          <Link to="/" className="navbar-brand">
            <i>
              <b className="text-color ms-1">Train Ticket Booking System</b>
            </i>
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link
                  to="/scheduled/train/all"
                  className="nav-link active"
                  aria-current="page"
                >
                  <b className="text-color">View Scheduled Train</b>
                </Link>
              </li>
